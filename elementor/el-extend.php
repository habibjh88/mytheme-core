...
class RT_Extende_Element_Widget {
	...
	public function __construct() {
		add_action( 'elementor/element/before_section_end', [ $this, 'mytheme_elementor_widget_extend' ], 10, 3 );
		add_action( 'elementor/widget/before_render_content', [ $this, 'mytheme_elementor_extend_widget_render' ] );
		//add_action( 'elementor/widget/print_template', array($this, 'mytheme_elementor_custom_content_template_print' ), 10, 2);
		//add_action( 'elementor/widget/render_content', array($this,'mytheme_elementor_custom_content_template_render'), 10, 2);
	...
	function add_elementor_section_background_controls( \Elementor\Element_Section $section ) {
		$section->add_control(
			'rt_section_parallax',
			[
				'label'        => __( 'Parallax', 'mytheme-core' ),
		...
		$section->add_control(
			...
			[
				'label'        => __( 'Parallax Transition off?', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_off'    => __( 'on', 'mytheme-core' ),
				'label_on'     => __( 'Off', 'mytheme-core' ),
				'default'      => 'off',
				'return_value' => 'off',
	...
	function custom_testimonial_control( $button, $args ) {
		...
		$button->add_control( 'custom_testimonial_author_position',
			[
				...
				'default'      => 'footer',
				'options'      => [
					'footer' => __( 'Footer', 'mytheme-core' ),
					'header' => __( 'Header', 'mytheme-core' ),
				],
		...
		$button->add_control( 'custom_testimonial_author_alignment',
			[
				'label'     => __( 'Author Alignment', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => 'default',
				'options'   => [
		...
		$button->add_control( 'custom_testimonial_quote_visibility',
			[
				'label'        => __( 'Quote Icon Visibility', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'disable',
				'options'      => [
		...
		$button->add_group_control(
			...
			[
				...
				'label'          => __( 'Choose Quote Image', 'mytheme-core' ),
				'types'          => [ 'classic'],
				'fields_options' => [
					'background' => [
						'default' => 'classic',
						'label'   => esc_html__( 'Choose Quote Image', 'mytheme-core' ),
					],
				],
				'exclude'        => [ 'color' ],
				'condition' => [
		...
		$button->add_control( 'custom_testimonial_control',
			[
				'label'        => __( 'Start Visibility', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'disable',
				'options'      => [
					'enable'        => __( 'Enable to Header', 'mytheme-core' ),
					'enable-footer' => __( 'Enable to Footer', 'mytheme-core' ),
					'disable'       => __( 'Disable', 'mytheme-core' ),
				],
		...
		$button->add_control( 'custom_testimonial_alignment',
			[
				'label'     => __( 'Start Alignment', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => 'center',
				'options'   => [
					'left'   => __( 'Left', 'mytheme-core' ),
		...
		$button->add_control(
			...
			[
				'label'     => __( 'Star Color', 'mytheme-core' ),
		...
		$button->add_control(
			...
			[
				'label'      => __( 'Star Size', 'mytheme-core' ),
		...
		$button->add_control(
			...
			[
				'label'     => __( 'Box Settings', 'mytheme-core' ),
		...
		$button->add_responsive_control(
			...
			[
				'label'      => __( 'Box Size', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$button->add_control( 'custom_testimonial_wrap_alignment',
			[
				'label'        => __( 'Box Alignment', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'center',
				'options'      => [
					'left'     => __( 'Left', 'mytheme-core' ),
					'center'   => __( 'Center', 'mytheme-core' ),
					'right'    => __( 'Right', 'mytheme-core' ),
					'absolute' => __( 'Absolute Center', 'mytheme-core' ),
				],
		...
		$button->add_control(
			...
			[
				'label'      => __( 'Box Vertical Position', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
	...
	function custom_button_control( $button, $args ) {
		$button->add_control( 'animation_btn_enable',
			[
				'label'        => __( 'Animation Button', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'enable',
				'options'      => [
					'enable'  => __( 'Enable', 'mytheme-core' ),
		...
		$button->add_control(
			...
			[
				'label'     => __( 'Hover Animation Color', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
	...
	function custom_counter_control( $counter, $args ) {
		$counter->add_control( 'counter_style',
			[
				'label'        => __( 'Counter Style', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SELECT,
				'default'      => 'default-style',
				'options'      => [
					'default-style' => __( 'Default', 'mytheme-core' ),
					'circle-style'  => __( 'Circle BG', 'mytheme-core' ),
				],
		...
		$counter->add_control(
			'bg_width',
			[
				'label'      => __( 'BG Width', 'mytheme-core' ),
	...
	public function mytheme_elementor_widget_extend( $section, $section_id, $args ) {
		/**
		...
		if ( 'image-carousel' === $section->get_name() && $section_id == 'section_counter' ) {
			$section->add_control(
				'counter_style',
				[
					'label'   => esc_html__( 'Counter', 'mytheme-core' ),
					'type'    => \Elementor\Controls_Manager::SELECT,
					'default' => 'default-style',
					'options' => [
						'default-style' => __( 'Default', 'mytheme-core' ),
	 ...
	 *
	 */
	public function mytheme_elementor_extend_widget_render( $widget ) {
		/**
