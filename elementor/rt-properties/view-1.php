...
if ( $data['isotope_enable'] ) {
	$isotope_enable = 'mytheme-isotope-wrapper';
}
...
?>
    ...
    <div class="rt-el-listing-wrapper product-grid <?php echo esc_attr( $data['layout'] . ' ' . $has_footer . ' ' . $data['category_position'] . ' ' . $data['hanging_visibility'] . ' ' . $isotope_enable ) ?>">
                                ...
                                <div class="product-thumb">
									...
									<?php if ( $listing->can_show_price() ): ?>
                                        <div class="product-price">
                                            ...
                                            <!-- Listing Author -->
											<?php if ( $display['author'] && method_exists( $listing, 'get_the_author_url' ) && $data['author_position'] === 'in_thumb' ): ?>
                                        ...
                                        <div class="listing-action">
											...
											<?php if ( class_exists( 'RtclPro' ) && Fns::is_enable_compare() ) {
                                                ...
                                                <a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#" data-toggle="tooltip" data-placement="top" title=""
                                                   data-original-title="<?php esc_html_e( "Compare", "mytheme-core" ) ?>" data-listing_id="<?php echo absint( $listing->get_id() ) ?>">
                                ...
                                <div class="product-top-content">
                                    ...
                                    <ul class="entry-meta">
										...
										<?php if ( $display['views'] ): ?>
                                            <li class="rt-views">
                                                <i class="far fa-eye"></i><?php echo sprintf(
													_n( "%s view", "%s views", $listing->get_view_counts(), 'mytheme-core' ),
