...
class Title extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		$this->rt_name = esc_html__( 'Section Title', 'mytheme-core' );
	...
	protected function register_controls() {
		...
		$this->add_control(
			'top_sub_title',
			[
				'label'       => esc_html__( 'Top Sub Title', 'mytheme-core' ),
		...
		$this->add_control(
			'title',
			[
				'label'       => esc_html__( 'Main Title', 'mytheme-core' ),
				'type'        => Controls_Manager::TEXTAREA,
				'rows'        => 3,
				'default'     => "We're going to became <br><span>partners for the long run</span>",
				'description' => esc_html__( "If you would like to use different color then separate word by <span>.", 'mytheme-core' ),
			]
		);
		...
		$this->add_control(
			'bg_title',
			[
				'label'   => esc_html__( 'Background Title', 'mytheme-core' ),
				'type'    => Controls_Manager::TEXT,
				'default' => 'Properties',
			]
		);
		...
		$this->start_controls_section(
			'additional_option',
			[
				'label' => esc_html__( 'Additional Option', 'mytheme-core' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		*/
		...
		$this->start_controls_section(
			'top_title_settings',
			[
				'label' => esc_html__( 'Top Sub Title Settings', 'mytheme-core' ),
		...
		$this->add_control(
			'top_title_icon',
			[
				'label'   => __( 'Choose Icons', 'mytheme-core' ),
		...
		$this->add_control(
			'icon_position',
			[
				'label'     => __( 'Border Style', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => 'left',
				'options'   => [
					'left'  => __( 'Left', 'mytheme-core' ),
					'right' => __( 'Right', 'mytheme-core' ),
					'both'  => __( 'Both', 'mytheme-core' ),
				],
				'condition' => [
					'top_title_icon!' => '',
				],
		...
		$this->start_controls_section(
			'title_settings',
			[
				'label' => esc_html__( 'Main Title Settings', 'mytheme-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'type'        => Controls_Manager::COLOR,
				'label'       => esc_html__( 'Color 2', 'mytheme-core' ),
				'description' => esc_html__( "If you would like to use different color then separate word by <span> from main title.", 'mytheme-core' ),
				'selectors'   => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Description Settings', 'mytheme-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => __( 'List Settings (if you use list item in description)', 'mytheme-core' ),
		...
		$this->add_control(
			'description_li_icon',
			[
				'label'     => __( 'List Icon', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '\f00c',
				'options'   => [
					''      => __( 'No Icon', 'mytheme-core' ),
					'\f00c' => __( 'Check', 'mytheme-core' ),
					'\f14a' => __( 'Check-square', 'mytheme-core' ),
					'\f105' => __( 'Angle-right', 'mytheme-core' ),
					'\f0da' => __( 'Caret-right', 'mytheme-core' ),
					'\f061' => __( 'Arrow-right', 'mytheme-core' ),
					'\f30b' => __( 'Long-arrow-alt-right', 'mytheme-core' ),
				],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::COLOR,
				'label'     => esc_html__( 'List Color', 'mytheme-core' ),
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Title Settings', 'mytheme-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'' => __( 'Absolute Position', 'mytheme-core' ),
					'static' => __( 'Position Static', 'mytheme-core' ),
					'relative' => __( 'Position Relative', 'mytheme-core' ),
				],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'options' => [
					'solid'  => __( 'Solid', 'mytheme-core' ),
					'outline' => __( 'Outline', 'mytheme-core' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Outline Width', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			'Common Settings',
			[
				'label' => esc_html__( 'Common Settings', 'mytheme-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'              => __( 'Wrapper Margin', 'mytheme-core' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px' ],
				'allowed_dimensions' => 'vertical',
				'default'            => [
