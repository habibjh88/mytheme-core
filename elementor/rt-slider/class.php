...
class RT_Slider extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		$this->rt_name = esc_html__( 'RT Slider', 'mytheme-core' );
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_rt_slider',
			[
				'label' => __( 'RT Slider', 'mytheme-core' ),
			]
		);
		...
		$this->add_control(
			'layout',
			[
				'label'   => __( 'Slider Style', 'mytheme-core' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'style1',
				'options' => [
					'style1' => __( 'Style 1 : Default slider', 'mytheme-core' ),
					'style2' => __( 'Style 2 : Logo slider', 'mytheme-core' ),
				],
			]
		);
		...
		$repeater->add_control(
			'slider_image',
			[
				'label'   => __( 'Slider Image', 'mytheme-core' ),
		...
		$repeater->add_control(
			'slider_subtitle', [
				'label'       => __( 'Subtitle', 'mytheme-core' ),
				'type'        => \Elementor\Controls_Manager::TEXTAREA,
				'default'     => __( 'Trust The Grounds Guys professionals to take care of your <br> commercial or residential grounds', 'mytheme-core' ),
				'label_block' => true,
				'rows'        => 4,
			]
		);
		...
		$repeater->add_control(
			'slider_link',
			[
				'label'       => __( 'Slider Link', 'mytheme-core' ),
		...
		$repeater->add_control(
			'slider_animation',
			[
				'label'     => __( 'Additional Settings', 'mytheme-core' ),
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'zoom-out' => __( 'Zoom Out', 'mytheme-core' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'        => __( 'Title Animation', 'mytheme-core' ),
		...
		$repeater->add_control(
			'title_x_paralax',
			[
				'label'      => __( 'Title Paralax X Axix', 'mytheme-core' ),
		...
		$repeater->add_control(
			'title_y_paralax',
			[
				'label'      => __( 'Title Paralax Y Axix', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			'title_paralax_scale',
			[
				'label'      => __( 'Title Paralax Scale', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			...
			[
				'label'      => __( 'Title Paralax Opcaity', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			...
			[
				'label'      => __( 'Title Paralax Duration', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			'title_paralax_delay',
			[
				'label'      => __( 'Title Paralax Delay', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			...
			[
				'label'        => __( 'Subtitle Animation', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off'    => __( 'Default', 'mytheme-core' ),
				'label_on'     => __( 'Custom', 'mytheme-core' ),
				'return_value' => 'yes',
		...
		$repeater->add_control(
			'subtitle_x_paralax',
			[
				'label'      => __( 'Sub Title Paralax X Axix', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			...
			[
				'label'      => __( 'Sub Title Paralax Delay', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_control(
			...
			[
				'label'        => __( 'Button Animation', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off'    => __( 'Default', 'mytheme-core' ),
				'label_on'     => __( 'Custom', 'mytheme-core' ),
				'return_value' => 'yes',
		...
		$repeater->add_control(
			'btn_paralax_delay',
			[
				'label'      => __( 'Button Paralax Delay', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$repeater->add_group_control(
			...
			[
				'name'           => 'overlay_bg',
				'label'          => __( 'Overlay', 'mytheme-core' ),
				'fields_options' => [
					'background' => [
						'label' => esc_html__( 'Overlay Type', 'mytheme-core' ),
					],
				],
		...
		$this->add_control(
			'sliders',
			[
				'label'       => __( 'Slider Items', 'mytheme-core' ),
				'type'        => \Elementor\Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'slider_title'    => 'BUILD <span>YOUR</span> BODY <span>STRONG</span>',
						'slider_subtitle' => __( 'Ready to change your physique, but can\'t work out in the gym?', 'mytheme-core' ),
					],
					[
		...
		$this->add_control(
			'carousel_images',
			[
				'label'      => esc_html__( 'Add Images', 'mytheme-core' ),
		...
		$this->add_responsive_control(
			'slider_height',
			[
				'label'      => __( 'Slider Height', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'vh' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Image Width / Height', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'slider_padding',
			[
				'label'      => __( 'Content Padding', 'mytheme-core' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Slider Radius', 'mytheme-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Enable Galelry Thumb', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Enable', 'mytheme-core' ),
				'label_off'    => __( 'Disable', 'mytheme-core' ),
				'return_value' => 'enable',
				'default'      => false,
				'condition'    => [
					'layout' => [ 'style1' ],
		...
		$this->add_control(
			'hide_all_content',
			[
				'label'        => __( 'Hide All Content', 'mytheme-core' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Image Opacity Hover', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Additional Options', 'mytheme-core' ),
			]
		);
		...
		$this->add_control(
			'main_slider_heading',
			[
				'label'     => __( 'Main Slider', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			'navigation',
			[
				'label'   => __( 'Navigation', 'mytheme-core' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'arrows',
				'options' => [
					'both'   => __( 'Arrows and Dots', 'mytheme-core' ),
					'arrows' => __( 'Arrows', 'mytheme-core' ),
					'dots'   => __( 'Dots', 'mytheme-core' ),
		...
		$this->add_control(
			'direction',
			[
				'label'     => __( 'Direction', 'mytheme-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'horizontal',
				'options'   => [
					'horizontal' => __( 'Horizontal', 'mytheme-core' ),
					'vertical'   => __( 'Vertical', 'mytheme-core' ),
				],
				'condition' => [
					'effect' => 'slide',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'yes',
				'options' => [
					'yes' => __( 'Yes', 'mytheme-core' ),
					'no'  => __( 'No', 'mytheme-core' ),
				],
		...
		$this->add_control(
			'pause_on_hover',
			[
				'label'       => __( 'Pause on Hover', 'mytheme-core' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'yes',
				'options'     => [
					'yes' => __( 'Yes', 'mytheme-core' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Pause on Interaction', 'mytheme-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'yes',
				'options'   => [
					'yes' => __( 'Yes', 'mytheme-core' ),
		...
		$this->add_responsive_control(
			'slidesPerView',
			[
				'label'              => __( 'Slides Per View', 'mytheme-core' ),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 1,
		...
		$this->add_responsive_control(
			'spaceBetween',
			[
				'label'     => __( 'Space Between', 'mytheme-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 0,
				'condition' => [
					'layout' => [ 'style2' ],
		...
		$this->add_control(
			'infinite',
			[
				'label'   => __( 'Infinite Loop', 'mytheme-core' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'yes',
				'options' => [
					'yes' => __( 'Yes', 'mytheme-core' ),
		...
		$this->add_control(
			'speed',
			[
				'label'       => __( 'Animation Speed', 'mytheme-core' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 500,
				'render_type' => 'none',
			]
		...
		$this->add_control(
			'animation_overflow',
			[
				'label'     => __( 'Animation Overflow', 'mytheme-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'hidden',
				'options'   => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Slider Gallery Settings', 'mytheme-core' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
		...
		$this->add_control(
			'gallery_per_view',
			[
				'label'     => __( 'Slider Per View', 'mytheme-core' ),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 1,
				'max'       => 10,
				'step'      => 1,
		...
		$this->start_controls_section(
			'section_style_title',
			[
				'label'     => __( 'Title Settings', 'mytheme-core' ),
		...
		$this->add_control(
			'title_color_2',
			[
				'label'     => __( 'Title Color - 2', 'mytheme-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => __( 'Sub Title Settings', 'mytheme-core' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'layout'            => 'style1',
					'hide_all_content!' => 'yes',
		...
		$this->add_control(
			'subtitle_color',
			[
				'label'     => __( 'Sub Title Color', 'mytheme-core' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'JOIN WITH US', 'mytheme-core' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Carousel Settings', 'mytheme-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options'   => [
					''                 => __( 'Always Visible', 'mytheme-core' ),
					'visible-on-hover' => __( 'Visible on hover', 'mytheme-core' ),
				],
				'condition' => [
		...
		$this->add_responsive_control(
			'arrows_width_height',
			[
				'label'     => __( 'Width / Height', 'mytheme-core' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 30,
		...
		$this->add_group_control(
			...
			[
				'name'      => 'border',
				'label'     => __( 'Arrow Border', 'mytheme-core' ),
		...
		$this->add_control(
			'dots_position',
			[
				'label'        => __( 'Position', 'mytheme-core' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'outside',
				'options'      => [
					'outside' => __( 'Outside', 'mytheme-core' ),
					'inside'  => __( 'Inside', 'mytheme-core' ),
				],
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Gallery Slider Style', 'mytheme-core' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'after',
				'condition' => [
					'layout' => 'style1',
		...
		$this->add_responsive_control(
			'gallery_height',
			[
				'label'      => __( 'Gallery Items Height', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'gallery_radius',
			[
				'label'      => __( 'Galelry Border Radius', 'mytheme-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'gallery_padding',
			[
				'label'      => __( 'Gallery Padding', 'mytheme-core' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'gallery_y_position',
			[
				'label'      => __( 'Gallery Y Position', 'mytheme-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
